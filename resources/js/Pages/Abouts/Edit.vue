                ...
                <div class="flex-auto p-4">
                    ...
                    <form @submit.prevent="submit">
                        <div class="flex flex-wrap">
                            ...
                            <div class="flex flex-wrap">
                            <div class="w-full lg:w-6/12 px-4">
                                <Link :href="route('about.index')" class="bg-gray-400 hover:bg-gray-500 text-white font-bold py-3 px-4 rounded mr-3">Kembali</Link>
                                <BreezeButton
...
export default {
    ...
    data() {
        return {
            form: useForm({
                title: this.$page.props.about['title'],
                content: this.$page.props.about['content'],
            }),
        };
    },
    ...
    methods: {
        submit() {
            this.form.put(this.route('about.update', this.$page.props.about['id']), {
