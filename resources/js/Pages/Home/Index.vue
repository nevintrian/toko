            ...
            <div class="container">
                <div class="flex flex-wrap">
                    <div class="self-center w-full px-4 lg:w-1/2 text-center">
                        <h1
                            class="block m-4 text-4xl font-poppins font-semibold lead text-dark dark:text-white lg:text-4xl sm:text-center md:text-center xl:text-center"
                        >
                            {{ homes?.data[0]?.title }}
                        </h1>
                        <p
                            class="mb-10 font-medium leading-relaxed text-slate-600"
                        >
                            {{ homes?.data[0]?.content }}
                        </p>
                        <a
                            :href="
                                'https://wa.me/62' +
                    ...
                    <div class="self-end w-full px-4 lg:w-1/2">
                        <div class="relative mt-10 lg:right-0 lg:mt-9">
                            <img
                                :src="'/uploads/homes/' + homes?.data[0]?.image"
                                alt="Brian Vidyanjaya"
                                class="relative z-10 w-1/2 mx-auto"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-800 py-16">
                <div class="flex flex-wrap">
                    <div class="self-end w-full px-4 lg:w-1/2">
                        <div class="relative mt-10 lg:right-0 lg:mt-9">
                            <img
                                :src="'/uploads/homes/' + homes?.data[1]?.image"
                                alt="Brian Vidyanjaya"
                                class="relative z-10 w-1/3 mx-auto"
                            />
                        </div>
                    </div>
                    <div class="self-center w-full px-4 lg:w-1/2 text-center">
