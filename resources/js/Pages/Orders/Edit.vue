...
export default {
    ...
    data() {
        return {
            form: useForm({
                code : this.$page.props.order['code'],
                customer_name : this.$page.props.order['customer_name'],
                total_price : this.$page.props.order['total_price'],
            }),
        };
    },
    ...
    methods: {
        submit() {
            this.form.put(this.route('order.update', this.$page.props.order['id']), {
