...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                _method: 'put',
                title : this.$page.props.home['title'],
                content : this.$page.props.home['content'],
                contact_id : this.$page.props.home['contact_id'],
                image : ''
            }),
        };
    },
    ...
    methods: {
        submit() {
            this.form.post(this.route('home.update', this.$page.props.home['id']), {
                _method: 'put',
                preserveState: true
            })
        },
